...
local function augroup(name, opts) return vim.api.nvim_create_augroup("nde_" .. name, opts) end
...
M.worktrees = augroup("Worktrees", { clear = true })
...
M.kubernetes = augroup("kubernetes", { clear = true })
