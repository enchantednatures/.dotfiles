...
function M.on_attach(client, buffer)
  ...
  self:map("<leader>cl", vim.lsp.codelens.run, { desc = "Code Lens" })
  self:map("gci", "Telescope lsp_incoming_calls", { desc = "[I]ncoming [C]alls" })
  self:map("gco", "Telescope lsp_outgoing_calls", { desc = "[O]utgoing [C]alls" })
